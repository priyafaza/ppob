...
@section('content')
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-2 mb-2">
            <a href="https://api.whatsapp.com/send?phone={{ $pelanggan->no_hp}}&text=Halo {{ $pelanggan->username }},%0AIni informasi cara pembayaran via transfer.%0A%0ASilahkan transfer sebesar Rp. {{ number_format($total,0,'.',',') }} ke salah satu rekening bank berikut ini.%0A%0A - 0240633221 BCA A/n Adi Nugroho%0A - 0404822070 BNI A/n Adi Nugroho%0A - 90012874718 BTPN/Jenius A/n Adi Nugroho%0A%0AAtau bisa juga melalui E-Wallet berikut.%0A*OVO*, *GoPay*, *Dana*, *LinkAja* dengan nomor hp 085732860740.%0AUntuk pembayaran metode lain silahkan tanya langsung aja. Terima Kasih.%0A%0AIjlik%0A_Pesan ini dibuat otomatis_" type="submit" class="btn btn-success btn-block btn-lg"><ion-icon name="logo-whatsapp"></ion-icon> Kirim Cara Pembayaran</a>
        </div>
